...
export interface RenderOptions<V extends Vue, S = {}>  // The props and store options special-cased by vue-testing-library and NOT passed to mount().
    extends // In TS 3.5+: Omit<ThisTypedMountOptions<V>, "store" | "props">
