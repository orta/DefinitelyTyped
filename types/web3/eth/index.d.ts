...
export default interface Eth {
    ...
    subscribe(type: 'logs', options?: Logs, callback?: Callback<Log>): Promise<Subscribe<Log>>;
    subscribe(type: 'syncing', callback?: Callback<any>): Promise<Subscribe<any>>;
    subscribe(type: 'newBlockHeaders', callback?: Callback<BlockHeader>): Promise<Subscribe<BlockHeader>>;
    subscribe(type: 'pendingTransactions', callback?: Callback<Transaction>): Promise<Subscribe<Transaction>>;
    subscribe(
