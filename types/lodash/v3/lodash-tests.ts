...
var foodsOrganic: IFoodOrganic[] = [{ name: 'banana', organic: true }, { name: 'beet', organic: false }];
...
var stoogesAges: IStoogesAge[] = [{ name: 'moe', age: 40 }, { name: 'larry', age: 50 }];
...
namespace TestAssign {
...

    {
        ...
        result = _(obj)
            .chain()
            .assign<S1, S2, S3, { a: number; b: number; c: number }>(s1, s2, s3);
        result = _(obj)
            .chain()
            .assign<S1, S2, S3, { a: number; b: number; c: number }>(s1, s2, s3, customizer);
        result = _(obj)
            .chain()
            .assign<S1, S2, S3, { a: number; b: number; c: number }>(s1, s2, s3, customizer, any);
    }

    {
        ...
        result = _(obj)
            .chain()
            .assign<S1, S2, S3, S4, { a: number; b: number; c: number; d: number }>(s1, s2, s3, s4);
        result = _(obj)
            .chain()
...

    {
        ...
        result = _(obj)
            .chain()
            .assign<{ a: number; b: number; c: number; d: number; e: number }>(s1, s2, s3, s4, s5);
        result = _(obj)
            .chain()
...
namespace TestDefaults {
...

    {
        ...
        result = _(obj)
            .chain()
            .defaults<S1, S2, S3, { a: string; b: number; c: number }>(s1, s2, s3);
    }
...

    {
        ...
        result = _(obj)
            .chain()
            .defaults<{ a: string; b: number; c: number; d: number; e: number }>(s1, s2, s3, s4, s5);
    }
}
...
namespace TestExtend {
...

    {
        ...
        result = _(obj)
            .chain()
            .extend<S1, S2, S3, Obj & S1 & S2 & S3>(s1, s2, s3, customizer, any);
    }

    {
        ...
        result = _(obj)
            .chain()
            .extend<S1, S2, S3, S4, Obj & S1 & S2 & S3 & S4>(s1, s2, s3, s4, customizer);
        result = _(obj)
            .chain()
            .extend<S1, S2, S3, S4, Obj & S1 & S2 & S3 & S4>(s1, s2, s3, s4, customizer, any);
    }

    {
        ...
        result = _(obj)
            .chain()
            .extend<Obj & S1 & S2 & S3 & S4 & S5>(s1, s2, s3, s4, s5, customizer);
        result = _(obj)
            .chain()
            .extend<Obj & S1 & S2 & S3 & S4 & S5>(s1, s2, s3, s4, s5, customizer, any);
    }
}
