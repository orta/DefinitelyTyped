...
export namespace v2 {
    class AgentsClient {
        ...
        setAgent(request: SetAgentRequest, cb?: (err: Error, agent: Agent) => void): Promise<[Agent]>;
        setAgent(
        ...
        deleteAgent(request: DeleteAgentRequest, cb?: (err: Error, agent: Agent) => void): Promise<void>;
        deleteAgent(
        ...
        getAgent(request: GetAgentRequest, cb?: (err: Error, agent: Agent) => void): Promise<[Agent]>;
        getAgent(
        ...
        searchAgents(request: SearchAgentRequest, cb?: (err: Error, agent: Agent) => void): Promise<Agent[]>;
        searchAgents(
...
export type ApiVersion = 'API_VERSION_UNSPECIFIED' | 'API_VERSION_V1' | 'API_VERSION_V2' | 'API_VERSION_V2_BETA_1';

// Represents the agent tier.
export type Tier = 'TIER_UNSPECIFIED' | 'TIER_STANDARD' | 'TIER_ENTERPRISE' | 'TIER_ENTERPRISE_PLUS';
