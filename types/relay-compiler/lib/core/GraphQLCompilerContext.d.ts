...
export class GraphQLCompilerContext {
    ...
    applyTransforms(transforms: ReadonlyArray<IRTransform>, reporter?: GraphQLReporter): GraphQLCompilerContext;
    applyTransform(transform: IRTransform, reporter?: GraphQLReporter): GraphQLCompilerContext;
    applyValidations(validations: ReadonlyArray<IRValidation>, reporter?: GraphQLReporter): void;
    ...
    withMutations(fn: (context: GraphQLCompilerContext) => GraphQLCompilerContext): GraphQLCompilerContext;
}
